...
export const MobileNavbar = () => {
  ...
  return (
    <div className='sticky z-20 top-0 w-full flex flex-row justify-between items-center p-2 bg-gray-300'>
...
export const DesktopNavbar = () => {
    return (
      <div className='w-full flex flex-row justify-between items-center p-2 bg-gray-300'>
